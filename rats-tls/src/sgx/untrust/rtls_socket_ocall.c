...
int ocall_setsockopt(int64_t sockfd, int level, int optname, const void *optval, uint32_t optlen)
{
	errno = 0;
...
int ocall_bind(int64_t sockfd, const struct rtls_sockaddr_in *addr, uint32_t addrlen)
{
	errno = 0;
...
int64_t ocall_accept(int64_t sockfd, struct rtls_sockaddr_in *addr, uint32_t addrlen_in,
...
int ocall_connect(int64_t sockfd, const struct rtls_sockaddr_in *addr, uint32_t addrlen)
{
	errno = 0;
