...
int64_t ocall_accept(int64_t sockfd, struct etls_sockaddr_in *addr, uint32_t addrlen_in,
...
int ocall_connect(int64_t sockfd, const struct etls_sockaddr_in *addr, uint32_t addrlen)
{
	errno = 0;
