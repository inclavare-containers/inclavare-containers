...
type initConfig struct {
	...
	EnclaveConfig    *enclaveConfigs.EnclaveConfig `json:"enclaveConfig"`
...
func newContainerInit(t initType, pipe *os.File, consoleSocket *os.File, fifoFd, logFd int, logLevel string, agentPipe *os.File) (initer, error) {
...
func setupUser(config *initConfig) error {
	...
	if config.RootlessEUID {
		...
		// this check earlier, but if libenclave.Process.User was typesafe
		// this might work.
		if len(addGroups) > 0 {
