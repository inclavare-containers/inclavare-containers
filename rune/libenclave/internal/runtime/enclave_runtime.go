...
type EnclaveRuntime interface {
	...
	Attest(string, string, uint32, uint32) ([]byte, error)
...
func (rt *EnclaveRuntimeWrapper) LaunchAttestation(spid string, subscriptionKey string, product uint32, quoteType uint32) ([]byte, error) {
