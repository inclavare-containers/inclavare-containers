...
def supply_chain():
  ...
  clone_cmd = ("in-toto-run"
                    " --step-name clone"
                    " --products inclavare-containers/rbi/bios-256k/Dockerfile"
                    " inclavare-containers/rbi/bios-256k/build-bios.sh"
                    " inclavare-containers/rbi/bios-256k/build-docker-image.sh"
                    " inclavare-containers/rbi/bios-256k/scripts/start.sh"
                    " --key alice"
  ...
  build_cmd = ("in-toto-run"
                    " --step-name build"
                    " --materials inclavare-containers/rbi/bios-256k/Dockerfile "
                    " inclavare-containers/rbi/bios-256k/build-bios.sh"
                    " inclavare-containers/rbi/bios-256k/build-docker-image.sh"
                    " inclavare-containers/rbi/bios-256k/scripts/start.sh"
                    " --products inclavare-containers/rbi/result/bios/bios-256k.bin"
                    " --key bob -- bash inclavare-containers/rbi/rbi.sh bios")

  print(build_cmd)
  print("This process may take about 3 minute..")
  ...
  pathlib.Path("final_product/inclavare-containers/rbi/result/bios").mkdir(parents = True, exist_ok = True)
  ...
  copyfile("functionary_bob/inclavare-containers/rbi/result/bios/bios-256k.bin", "final_product/inclavare-containers/rbi/result/bios/bios-256k.bin")
